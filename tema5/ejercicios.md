...
- Capa: 8 Cabeza: 5 (puede variar ligeramente según ejecución/modelo)
...
- En qué capa y cabeza la encuentras?
- Capa: 10 Cabeza: 3 (puede variar ligeramente según ejecución/modelo)
...
|----------------|--------------|---------------|
| Tipo de arquitectura (enc/dec/enc-dec) | Decoder-only | Escala bien y cubre generación, resumen y QA con prompting/instruction tuning |
| d_model (dimensión del modelo) | 1024 | Buen equilibrio entre capacidad y coste de cómputo para 1x A100 |
| num_heads (cabezas de atención) | 16 | Mantiene d_k=64 (1024/16), configuración estándar y estable |
| num_layers (capas) | 24 | Profundidad suficiente para modelar relaciones complejas sin sobredimensionar |
| d_ff (dimensión feed-forward) | 4096 | Sigue la regla habitual d_ff = 4*d_model |
| seq_length (longitud máxima) | 4096 | Cumple el requisito de contexto de hasta 4,000 tokens |
| vocab_size (tamaño del vocabulario) | 32,000 | Tamaño razonable para subpalabras en español técnico |
| dropout | 0.1 | Regularización estándar para mejorar generalización |
...
Convierte a millones (M) de parámetros: 335.1 M
